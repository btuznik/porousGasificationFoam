...
Application
    dummyPressurePorousGasificationFoam

Description
    Solver for gas flux tests through porous media including mass sources
...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        Info<< "total dummySource = " << gSum(dummySrho) << " kg/m3/s"  << endl;
